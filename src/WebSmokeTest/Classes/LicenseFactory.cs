        ...
        public string SaveLicense(in ILicense license)
        {
            ...
            using (MemoryStream ms = new MemoryStream())
            {
                using (BinaryWriter binaryWriter = new BinaryWriter(ms))
                {
                    ...
                    binaryWriter.Write(license.MaximumRunningTests);
                    binaryWriter.Write(license.MaximumConfigurations);
                    binaryWriter.Write(license.MaximumPageScans);
                    binaryWriter.Write(license.MaximumOpenEndpoints);
                    binaryWriter.Write(license.MaximumTestsToRun);
                    binaryWriter.Write(license.MaximumTestSchedules);
